...
The codes to replicate the results displayed in the paper are presented in this ebook. 

We also provide the codes in an archive file.
...
To visualize the notebook, open the followinf file in a browser: `Supplementary-materials/replication_book/index.html`.
