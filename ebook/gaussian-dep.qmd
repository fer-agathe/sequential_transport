...
`r add_tikz_graph(tikz_code = causal_graph_tikz(adj_indep_correct), label = "fig-causal-graph-indep-correct", caption = "\"Assumed Causal Graph: Correct Model\"", echo = "false")`
...
`r add_tikz_graph(tikz_code = causal_graph_tikz(adj_indep_inc_x1_then_x2), label = "fig-causal-graph-indep-incorrect-1", caption = "\"Assumed Causal Graph: Incorrecly Assumes that $X_1$ causes $X_2$\"", echo = "false")`
...
`r add_tikz_graph(tikz_code = causal_graph_tikz(adj_indep_inc_x2_then_x1), label = "fig-causal-graph-indep-incorrect-2", caption = "\"Assumed Causal Graph: Incorrecly Assumes that $X_2$ causes $X_1$\"", echo = "false")`
