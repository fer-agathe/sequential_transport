...
legend(
  "topleft", 
  pch = 19, col = colours_all[c("factual", "naive", "ot", "fairadapt", "seq")], 
  legend = names(colours_all[c("factual", "naive", "ot", "fairadapt", "seq")]),
  box.lty=0
)
...
text(x = .15, y = 6, "Factuals", col = colours_all[["source"]])
pos_arrow <- .2
...
polygon(d_unaware_factuals_black, col = alpha(colours_all[["source"]], .5), border = NA)
lines(d_unaware_factuals_white, col = colours_all[["reference"]], lty = 2, lwd = 2)
polygon(d_unaware_seq_black_star, col = alpha(colours_all[["seq"]], .5), border = NA)
text(x = .53, y = 6, "Seq. T.", col = colours_all[["seq"]])
```
...
text(x = .25, y = 6, "Factuals", col = colours_all[["source"]])
pos_arrow <- .2
...
polygon(d_aware_factuals_black, col = alpha(colours_all[["source"]], .5), border = NA)
lines(d_aware_factuals_white, col = colours_all[["reference"]], lty = 2, lwd = 2)
polygon(d_aware_seq_black_star, col = alpha(colours_all[["seq"]], .5), border = NA)
text(x = .53, y = 6, "Seq. T.", col = colours_all[["seq"]])
