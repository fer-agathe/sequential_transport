...
pos_arrow_ref <- .7
text(x = pos_arrow_ref, y = 2, "Factuals - White", col = colours_all[["reference"]])
...
text(x = .3, y = 2.5, "Naive", col = colours_all[["naive"]])
...
text(x = .7, y = 2.5, "Factuals - Non-White", col = colours_all[["source"]])
pos_arrow <- .6
...
text(x = .3, y = 2.5, "fairadapt", col = colours_all[["fairadapt"]])
...
text(x = .3, y = 2.5, "Seq. T.", col = colours_all[["seq"]])
```
...
text(x = .15, y = 2.5, "Factuals - Non-White", col = colours_all[["source"]])
pos_arrow <- .2
...
pos_arrow_ref <- .1
text(x = .05, y = 2, "Factuals - White", col = colours_all[["reference"]])
...
text(x = .7, y = 2, "Naive", col = colours_all[["naive"]])
...
text(x = .7, y = 2, "fairadapt", col = colours_all[["fairadapt"]])
...
text(x = .7, y = 2, "Seq. T.", col = colours_all[["seq"]])
```
