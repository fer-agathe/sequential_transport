...
## Illustrative example: small grid
...
A function to transport $x_1$ conditionnaly on $x_2$, i.e., $T_1^*(x_1 | x_2)$:
...
- `x2_then_x1`: $T_1^*(x1 | x2), T_2^*(x2)$, the transported value when assuming 

```{r}
prediction <- data.frame(
  start = xystart, # (x1, x2)
  # Computing (T_1(x1 | x2), T_2(x2))
  x2_then_x1 = c(
    transport_x1_cond_x2(x1 = xystart[1], x2 = xystart[2]),
    transport_x2(xystart[2])
  ),
  # Computing (T_1(x1), T_2(x2 | x1))
  x1_then_x2 = c(
